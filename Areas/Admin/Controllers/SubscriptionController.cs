...
namespace Memberships.Areas.Admin.Controllers
{
    public class SubscriptionController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,RegistrationCode,Description,Title")] Subscription subscription)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,RegistrationCode,Description,Title")] Subscription subscription)
        {
            if (ModelState.IsValid)
            {
